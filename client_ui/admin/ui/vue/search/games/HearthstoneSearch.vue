...
import { HearthstoneGame, searchForGames } from '@client/ts/games'

@Component
export default class HearthstoneSearch extends Vue {
    matchSearch: string = ''
    userSearch: string = ''
    searching: boolean = false
    games: HearthstoneGame[] = []

    searchMatches() {
        searchForGames<HearthstoneGame>('hearthstone', {
