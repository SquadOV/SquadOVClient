...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fprotobuf_2fany_5ftest_2eproto_metadata_getter(int index);
...
class TestAny PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fprotobuf_2fany_5ftest_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void TestAny::set_text(const std::string& value) {
...
inline void TestAny::set_text(std::string&& value) {
  
  text_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:protobuf_unittest.TestAny.text)
}
inline void TestAny::set_text(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:protobuf_unittest.TestAny.text)
}
inline void TestAny::set_text(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:protobuf_unittest.TestAny.text)
}
