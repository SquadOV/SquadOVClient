...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_2eproto_metadata_getter(int index);
...
class DefaultValueTestCases PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void DoubleMessage::set_str_value(const char* value) {
  ...
  value_.str_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
