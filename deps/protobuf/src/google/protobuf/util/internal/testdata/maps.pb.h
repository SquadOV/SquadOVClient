...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fmaps_2eproto_metadata_getter(int index);
...
class MapsTestCases PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2fmaps_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void MapOfObjects_M::set_inner_text(const char* value) {
  ...
  inner_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:proto_util_converter.testing.MapOfObjects.M.inner_text)
}
inline void MapOfObjects_M::set_inner_text(const char* value,
    size_t size) {
  
  inner_text_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline void MapOut::set_bar(const char* value) {
  ...
  bar_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:proto_util_converter.testing.MapOut.bar)
}
inline void MapOut::set_bar(const char* value,
    size_t size) {
  
  bar_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline void MapM::set_foo(const char* value) {
  ...
  foo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:proto_util_converter.testing.MapM.foo)
}
inline void MapM::set_foo(const char* value,
    size_t size) {
  
  foo_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
