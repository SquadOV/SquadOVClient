...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_metadata_getter(int index);
...
class OneOfsRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void OneOfsRequest::set_str_data(const char* value) {
  ...
  data_.str_data_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
...
inline void MoreData::set_str_value(const char* value) {
  ...
  str_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:proto_util_converter.testing.oneofs.MoreData.str_value)
}
inline void MoreData::set_str_value(const char* value,
    size_t size) {
  
  str_value_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
