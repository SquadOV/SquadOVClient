...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fprotobuf_2fmap_5funittest_2eproto_metadata_getter(int index);
...
class TestMap PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fprotobuf_2fmap_5funittest_2eproto_metadata_getter(kIndexInFileMessages);
  }
