...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fprotobuf_2funittest_5fmset_2eproto_metadata_getter(int index);
...
class TestMessageSetContainer PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fprotobuf_2funittest_5fmset_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void TestMessageSetExtension1::set_test_aliasing(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  test_aliasing_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:protobuf_unittest.TestMessageSetExtension1.test_aliasing)
}
inline void TestMessageSetExtension1::set_test_aliasing(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  test_aliasing_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
